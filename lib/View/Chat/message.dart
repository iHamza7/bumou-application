...
class _MessageViewState extends State<MessageView> {
  ...
  late final ChatMessagesController cntrlr;
  ...
  void initState() {
    super.initState();
    cntrlr = Get.put(
        ChatMessagesController()); // Ensure proper binding of controller
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Obx(() {
            return cntrlr.selectionMode.value
                ? IconButton(
                    icon: Icon(Icons.delete),
                    onPressed: cntrlr.deleteSelectedMessages,
                  )
                : SizedBox.shrink();
          }),
        ],
